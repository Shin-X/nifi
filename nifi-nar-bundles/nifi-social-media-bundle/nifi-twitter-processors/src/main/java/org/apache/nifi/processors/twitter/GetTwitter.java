...
@CapabilityDescription("从Twitter的流API中提取状态变化。从1.9.0开始的版本中，消费者密钥和访问令牌根据https://developer.twitter.com/en/docs/basics/authentication/guides/securing-keys-and-tokens被标记为敏感")
