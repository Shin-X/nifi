...
<div id="parameter-contexts" class="hidden">
    ...
    <div id="parameter-contexts-header-text" class="parameter-contexts-header-text">NiFi参数上下文</div>
    ...
    <div id="parameter-contexts-refresh-container">
        ...
        <div id="parameter-contexts-last-refreshed-container" class="last-refreshed-container">
            <%--Last updated--%>最后更新:&nbsp;<span id="parameter-contexts-last-refreshed" class="value-color"></span>
        </div>
