...
<div id="port-configuration" class="hidden medium-dialog">
    <div class="dialog-content">
        <div class="port-setting">
            <div class="setting-name"><%--Port name--%>端口名称</div>
            <div class="setting-field">
                <div id="port-name-container">
                    ...
                    <div class="port-enabled-container">
                        ...
                        <span class="nf-checkbox-label"> <%--Enabled--%> 可用</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="port-concurrent-task-container" class="port-setting">
            <div class="setting-name">
                ...
                <div class="fa fa-question-circle" alt="Info" title="<%--The number of tasks that should be concurrently scheduled for this port.--%>应该同时为该端口调度的任务数。"></div>
            </div>
            <div class="setting-field">
