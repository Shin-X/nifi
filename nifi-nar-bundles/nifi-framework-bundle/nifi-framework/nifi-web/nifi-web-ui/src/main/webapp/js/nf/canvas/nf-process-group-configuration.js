    ...
    var saveConfiguration = function (version, groupId) {
        ...
        $.ajax({
            ...
            nfDialog.showOkDialog({
                headerText: /*'Process Group Configuration'*/'进程组配置',
                dialogContent: '进程组配置保存成功。'
            ...
            var comboOptions = {
                ...
                select: function (option) {
                    ...
                    if (typeof option.value === 'undefined') {
                        $('#parameter-context-dialog').modal('setHeaderText', /*'Add Parameter Context'*/'添加参数上下文').modal('setButtonModel', [{
                            buttonText: /*'Apply'*/'应用',
                            color: {
                                base: '#728E9B',
                                hover: '#004849',
