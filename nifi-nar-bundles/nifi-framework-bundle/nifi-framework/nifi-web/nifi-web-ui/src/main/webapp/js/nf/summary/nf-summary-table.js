...
(function (root, factory) {
    ...
    var initSummaryTable = function (isClustered) {
        ...
        $('#cluster-processor-summary-dialog').modal({
            ...
            headerText: /*'Cluster Processor Summary'*/'集群处理器概要',
            buttons: [{
                buttonText: /*'Close'*/'关闭',
                color: {
                    base: '#728E9B',
        ...
        $('#cluster-connection-summary-dialog').modal({
            scrollableContentStyle: 'scrollable',
            headerText: /*'Cluster Connection Summary'*/'集群连接概要',
            buttons: [{
                buttonText: /*'Close'*/'关闭',
                color: {
                    base: '#728E9B',
        ...
        $('#cluster-process-group-summary-dialog').modal({
            scrollableContentStyle: 'scrollable',
            headerText: /*'Cluster Process Group Summary'*/'集群进程组概要',
            buttons: [{
                buttonText: /*'Close'*/'关闭',
                color: {
                    base: '#728E9B',
        ...
        $('#cluster-input-port-summary-dialog').modal({
            scrollableContentStyle: 'scrollable',
            headerText: /*'Cluster Input Port Summary'*/'集群输入端口摘要',
            buttons: [{
                buttonText: /*'Close'*/'关闭',
                color: {
                    base: '#728E9B',
        ...
        $('#cluster-output-port-summary-dialog').modal({
            scrollableContentStyle: 'scrollable',
            headerText: /*'Cluster Output Port Summary'*/'集群输出端口摘要',
            buttons: [{
                buttonText: /*'Close'*/'关闭',
                color: {
                    base: '#728E9B',
        ...
        $('#cluster-remote-process-group-summary-dialog').modal({
            scrollableContentStyle: 'scrollable',
            headerText: /*'Cluster Remote Process Group Summary'*/'集群远程进程组概要',
            buttons: [{
                buttonText: /*'Close'*/'关闭',
                color: {
                    base: '#728E9B',
        ...
        $('#system-diagnostics-dialog').modal({
            scrollableContentStyle: 'scrollable',
            headerText: /*'System Diagnostics'*/'系统诊断',
            buttons: [{
                buttonText: /*'Close'*/'关闭',
                color: {
                    base: '#728E9B',
