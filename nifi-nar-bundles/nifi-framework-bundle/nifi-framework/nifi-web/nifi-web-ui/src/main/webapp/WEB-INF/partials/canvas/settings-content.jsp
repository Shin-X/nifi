...
<div id="settings" class="hidden">
    <div id="settings-header-text" class="settings-header-text"><%--NiFi Settings--%>NiFi设置</div>
                ...
                <div id="general-settings">
                    <div class="setting">
                        <div class="setting-name">
                            <%--Maximum timer driven thread count--%>最大计时器驱动线程数
                            <div class="fa fa-question-circle" alt="Info" title="系统可用的计时器驱动处理器的最大线程数。"></div>
                    ...
                    <div class="setting">
                        <div class="setting-name">
                            <%--Maximum event driven thread count--%>最大事件驱动线程数
                    ...
                    <div class="editable settings-buttons">
                        <div id="settings-save" class="button"><%--Apply--%>应用</div>
                        <div class="clear"></div>
                    </div>
                </div>
            </div>
    ...
    <div id="settings-refresh-container">
        ...
        <div id="settings-last-refreshed-container" class="last-refreshed-container">
            <%--Last updated--%>最后更新:&nbsp;<span id="settings-last-refreshed" class="value-color"></span>
        </div>
