    ...
    var updateProcessGroups = function (updated) {
        ...
        updated.each(function (processGroupData) {
            ...
            if (processGroup.classed('visible')) {
                ...
                transmittingCount.append("title").text("传输远程过程组");
                ...
                notTransmittingCount.append("title").text("不传输远程过程组")
                ...
                runningCount.append("title").text("运行组件");
                ...
                stoppedCount.append("title").text("停止组件");
                ...
                invalidCount.append("title").text("无效的组件");
                ...
                disabledCount.append("title").text("禁用的组件");
                ...
                upToDateCount.append("title").text("最新版本的进程组");
                ...
                locallyModifiedCount.append("title").text("本地修改版本的进程组");
                ...
                staleCount.append("title").text("过时版本的进程组");
                ...
                locallyModifiedAndStaleCount.append("title").text("本地修改和过时版本的流程组");
                ...
                syncFailureCount.append("title").text("同步失败版本的进程组");
        ...
        enterGroup: function (groupId) {
            ...
            return nfCanvasUtils.reload(groupId).done(function () {
                ...
                nfDialog.showOkDialog({
                    headerText: /*'Process Group'*/'进程组',
                    dialogContent: '无法进入所选组。'
