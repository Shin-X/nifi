        ...
        <div class="setting" style="margin-bottom: 0px;">
            <div class="end-date-setting">
                <div class="setting-name">
                    <%--End date--%>结束日期
                    <div class="fa fa-question-circle" alt="Info" title="清除结束日期格式为'mm/dd/yyyy'。还必须指定结束时间。"></div>
            ...
            <div class="end-time-setting">
                <div class="setting-name">
                    ...
                    <div class="fa fa-question-circle" id="purge-end-time-info" alt="Info" title="格式为“hh:mm:ss”的结束时间。还必须指定结束日期。"></div>
