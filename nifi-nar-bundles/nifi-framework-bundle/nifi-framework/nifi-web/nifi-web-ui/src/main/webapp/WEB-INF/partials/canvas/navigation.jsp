...
<div id="graph-controls">
    <div id="navigation-control" class="graph-control">
        ...
        <div class="graph-control-header-container hidden pointer"
            ...
            <div class="graph-control-header"><!-- Navigate -->导航</div>
        ...
        <div class="graph-control-content hidden">
            <div id="navigation-buttons">
                ...
                <div id="naviagte-zoom-fit" class="action-button" title="合适"
                ...
                <div id="naviagte-zoom-actual-size" class="action-button" title="实际"
    ...
    <div id="operation-control" class="graph-control">
        ...
        <div class="graph-control-header-container hidden pointer"
            ...
            <div class="graph-control-header"><!-- Operate -->操作</div>
            <div class="graph-control-header-action">
                <div class="graph-control-expansion fa fa-plus-square-o pointer"></div>
            </div>
            <div class="clear"></div>
        ...
        <div class="graph-control-content hidden">
            ...
            <div id="operation-buttons">
                <div>
                    ...
                    <div id="operate-start" class="action-button" title="开始">
                    ...
                    <div id="operate-stop" class="action-button" title="结束">
                ...
                <div style="margin-top: 5px;">
                    ...
                    <div id="operate-copy" class="action-button" title="复制">
                    ...
                    <div id="operate-color" class="action-button" title="改变颜色">
