                        ...
                        if (updateRequest.complete === true) {
                            if (errored) {
                                nfDialog.showOkDialog({
                                    headerText: /*'Variable Update Error'*/'变量更新错误',
        ...
        if (variableName !== '') {
            ...
            if (matchingVariable === null) {
                ...
                if (matchingVariable.hidden === true) {
                    ...
                    nfDialog.showOkDialog({
                        headerText: /*'Variable Exists'*/'变量已存在',
                        // dialogContent: 'A variable with this name already exists.'
                        dialogContent: '这个变量名称已经存在。'
                    });
