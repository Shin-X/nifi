...
(function (root, factory) {
    ...
    var initDetailsDialog = function () {
        $('#action-details-dialog').modal({
            ...
            headerText: /*'Action Details'*/'活动详情',
            buttons: [{
                buttonText: /*'Ok'*/'确定',
                color: {
                    base: '#728E9B',
    ...
    var initFilterDialog = function () {
        ...
        $('#history-filter-dialog').modal({
            scrollableContentStyle: 'scrollable',
            headerText: /*'Filter History'*/'过滤历史',
            buttons: [{
                buttonText: /*'Filter'*/'过滤',
                color: {
                    base: '#728E9B',
                    hover: '#004849',
                    text: '#ffffff'
                    ...
                    click: function () {
                        ...
                        if (endDate !== '') {
                            ...
                            nfDialog.showYesNoDialog({
                                ...
                                dialogContent: "您确定要删除之前的所有历史记录吗 '" + nfCommon.escapeHtml(endDateTime) + " " + nfCommon.escapeHtml(timezone) + "'?",
                                yesHandler: function () {
