...
(function (root, factory) {
    ...
    var promptForConnect = function (node) {
        ...
        nfDialog.showYesNoDialog({
            headerText: /*'Connect Node'*/'连接节点',
            dialogContent: '连接 \'' + formatNodeAddress(node) + '\' 这个集群?',
    ...
    var promptForDisconnect = function (node) {
        ...
        nfDialog.showYesNoDialog({
            headerText: /*'Disconnect Node'*/'断开连接节点',
            dialogContent: '断开连接 \'' + formatNodeAddress(node) + '\' 从这个集群?',
    ...
    var promptForRemoval = function (node) {
        // prompt for disconnect
        nfDialog.showYesNoDialog({
            headerText: /*'Remove Node'*/'删除节点',
            dialogContent: '删除 \'' + formatNodeAddress(node) + '\' 从这个集群?',
