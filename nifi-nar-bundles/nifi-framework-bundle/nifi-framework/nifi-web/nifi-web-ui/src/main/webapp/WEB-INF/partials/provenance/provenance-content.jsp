...
<div id="provenance">
    ...
    <div id="provenance-header-text"><%--NiFi Data Provenance--%>NiFi数据来源</div>
    <div id="provenance-event-search" class="provenance-panel">
        <div id="provenance-filter-controls" class="filter-controls">
            <div id="provenance-filter-stats" class="filter-status">
                <%--Displaying--%>显示&nbsp;<span id="displayed-events"></span>&nbsp;of&nbsp;<span id="total-events"></span>
            </div>
            <div id="oldest-event-message">
                <%--Oldest event available--%>最早可用事件:&nbsp;<span id="oldest-event" class="value-color"></span>
            </div>
        ...
        <div id="provenance-search-container">
            <div id="provenance-search-overview">
                ...
                <span id="clear-provenance-search" class="link"><%--Clear search--%>清除搜索</span>
            </div>
        ...
        <div id="provenance-refresh-container">
            ...
            <div id="provenance-last-refreshed-container" class="last-refreshed-container">
                <%--Last updated--%>最后更新:&nbsp;<span id="provenance-last-refreshed" class="value-color"></span>
            </div>
