...
@CapabilityDescription("从HL7(健康级别7)格式化的流文件中提取信息，并将信息作为流文件属性添加。属性命名为<Segment Name> <dot> <Field Index>。" +
        "如果段是重复的，命名为<Segment Name> <underscore> <Segment Index> <dot> <Field Index>。" +
        "例如，we may have an attribute named \"MHS.12\" with a value of \"2.1\" and an attribute named \"OBX_11.3\" with a value of \"93000^CPT4\"。")
