...
@CapabilityDescription("使用Kafka 2.5 Producer API将流文件的内容作为消息发送给Apache Kafka。要发送的消息可以是单独的流文件，也可以使用用户指定的分隔符(如new-line)进行分隔。用于获取消息的补充性NiFi处理器是ConsumeKafka_2_6。")
