...
@CapabilityDescription("尝试根据RFC5424和RFC3164格式解析Syslog消息的内容，并为Syslog消息的每个部分添加属性。注意:请注意，RFC3164是信息性的，并且有很多不同的实现。如果消息解析失败，考虑使用RFC5424或使用通用解析处理器，如ExtractGrok。")
